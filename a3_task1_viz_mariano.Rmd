...
**Figure 1.** Oil spill events in California in 2008. Data is divided based on location.Green and yellow points indicate inland and marine event locations, respectively. Data: CDFW (2009). 
...
**Figure 2.** Count of California’s inland oil spill events by county in 2008. County color, from salmon to dark red, reflects the number of inland oil spill incidents. Data: CDFW (2009).
